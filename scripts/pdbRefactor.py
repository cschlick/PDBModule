...
sys.path.append("/home/user/PycharmProjects/PDBModule/")
...
Where 'TYPE' is the output type 'phenix' or 'chimera'
And 'SECTION' is optional, can be 'asu' or 'patch'

Also requires a parameter file located either in the working directory, or one or two directories up.
...
These are used to divide up a pdb into symmetric sections, assuming the order they occur in the pdb is Asu1, Asu2, Asu3, etc.
